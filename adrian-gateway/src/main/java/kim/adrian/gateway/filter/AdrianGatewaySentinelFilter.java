...
import kim.adrian.gateway.fallback.AdrianGatewayBlockFallbackProvider;
 ...
 * @author by feng-dan
 * @version 1.0v
 * @ClassName AdrianGatewaySentinelFilter
 * @Description Sentinel验证码限流
 * @Date 2020-01-07 13:49
 */
@Slf4j
@Configuration
public class AdrianGatewaySentinelFilter {
    ...
    @PostConstruct
    public void doInit() {
        ZuulBlockFallbackManager.registerProvider(new AdrianGatewayBlockFallbackProvider());
        initGatewayRules();
    }
